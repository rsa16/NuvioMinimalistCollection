...
## Usage
1. Import the AIOMetadata Config under Configuration > Import Config
2. Import the Nuvio Collections Config in Nuvio's web [settings](https://nuvio.tv/account?tab=overview), which is easier in my opinion. There, go to Collections > Import. 
3. Boom. Enjoy.

## Changes
- set `coverImageUrl` for all items in collection, set to the first frame of the GIF statically
- replaced image host with personal
